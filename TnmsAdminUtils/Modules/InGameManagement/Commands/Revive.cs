...
public class Revive(IServiceProvider provider) : TnmsAbstractCommandBase(provider)
{
    public override string CommandName => "revive";
    public override string CommandDescription => "Revives a player (alive or dead).";
